...
const UnlinkedMembersSection = ({ members, onLinkOrCreate, isLoading }) => {
  ...
  return (
    <Card className="shadow-xl mt-6">
      <CardHeader>
        <CardTitle className="text-xl text-orange-400">Membros Ativos Sem Conta no Painel</CardTitle>
        <CardDescription className="text-muted-foreground">
          Estes membros ativos não têm uma conta de acesso ao painel vinculada.
          Você pode criar ou vincular uma conta para eles.
        </CardDescription>
      </CardHeader>
      <CardContent>
          ...
          <Table>
            <TableHeader className="bg-muted/30">
              <TableRow>
                ...
                <TableHead className="font-semibold">Email Atual (se houver)</TableHead>
                  ...
                  <TableCell className="py-3 text-right">
                    <Button 
                      ...
                      onClick={() => {
                        ...
                        onLinkOrCreate(member, newEmail.trim());
                      }}
