      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          <NavLink to="/" className="flex items-center space-x-3 group focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 rounded-lg">
             <motion.img 
                src="https://storage.googleapis.com/hostinger-horizons-assets-prod/8b34e97e-b1fb-436b-96f9-daf091378bb8/c25396be5f48be7359286fb7f650e260.png"
          ...
          <div className="hidden md:flex items-center space-x-2">
            {navLinks}
            {user && <ProfileDropdown userRole={userRole} onLogout={handleLogout} />}
          </div>
              ...
              {user && (
                <>
                  ...
                  {(userRole === 'admin' || userRole === 'moderador' || userRole === 'recrutador') && (
                    <NavItem to="/admin/dashboard" icon={<Home />}>Meu Painel</NavItem>
                  )}
