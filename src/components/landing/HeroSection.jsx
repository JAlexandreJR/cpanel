      ...
      <div className="max-w-4xl mx-auto flex flex-col items-center"> 
        ...
        >
           <div className="w-40 h-40 md:w-48 md:h-48 flex items-center justify-center rounded-2xl">
             <img src="https://storage.googleapis.com/hostinger-horizons-assets-prod/8b34e97e-b1fb-436b-96f9-daf091378bb8/cc4f42d355b391bbfd3dd0f5d604be74.png" alt="Logo do Clã GERR" className="w-full h-full object-contain" />
           </div>
        </motion.div>
        <motion.h1 
