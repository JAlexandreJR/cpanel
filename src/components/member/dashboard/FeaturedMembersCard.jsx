...
import { Loader2, Star, Award, AlertTriangle, UserCircle } from 'lucide-react';
          ...
          >
            ...
            <CardContent className="pt-8 flex flex-col items-center text-center relative z-10">
              ...
              <div className="mt-5 pt-4 border-t border-primary/20 w-full">
                <h4 className="text-sm font-semibold text-muted-foreground mb-3">Biografia</h4>
                <div className="flex justify-center items-center text-center h-16 text-sm text-slate-300 italic px-4">
                  {member.biography ? (
                    <p className="line-clamp-3">"{member.biography}"</p>
                  ) : (
