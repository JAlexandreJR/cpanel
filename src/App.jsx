...
import React from 'react';
    ...
    function ProtectedRoute({ children, allowedRoles }) {
      ...
      if (allowedRoles && !allowedRoles.includes(userRole)) {
        // Se o usuário não tem a role permitida, redireciona para o dashboard de membro como padrão.
    ...
    const AppRoutes = () => {
      ...
      if (loading) {
        return <div className="flex flex-col items-center justify-center h-screen bg-background"><Loader2 className="h-12 w-12 text-primary animate-spin mb-4" /><p className="text-xl text-muted-foreground">Carregando...</p></div>;
      }
      ...
      return (
        <MainLayout>
          <Routes>
            ...
            />
            <Route 
              path="/admin/commanding-officers"
              element={
                <ProtectedRoute allowedRoles={['admin', 'moderador']}>
