import React, { useState, useEffect, useCallback, useMemo } from 'react';
    ...
    const ADVERTENCIA_TIPOS = ["Advertencia Verbal", "Advertencia Nivel 1", "Advertencia Nivel 2"];
    ...
    const WarningsManagementPage = () => {
      ...
      const getAdvertenciaTipoBadge = (tipo) => {
          ...
          if (tipo === "Advertencia Nivel 1") variant = "warning";
          else if (tipo === "Advertencia Nivel 2") variant = "destructive";
