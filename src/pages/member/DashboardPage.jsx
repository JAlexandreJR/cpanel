...
import { Info, Loader2, Menu } from 'lucide-react';
...
import DashboardStatsGrid from '@/components/member/dashboard/DashboardStatsGrid';
...
const MemberDashboardPage = () => {
  ...
  return (
    <div className="relative">
      ...
      >
        <DashboardHeader memberData={memberData} user={user} variants={cardVariants} />

        <motion.div variants={cardVariants} className="mb-8">
            <FeaturedMembersCard />
        </motion.div>

        <DashboardStatsGrid memberData={memberData} variants={cardVariants} />
