...
const LoginBackground = ({ backgroundUrl }) => {
  const isVideo = backgroundUrl && (backgroundUrl.endsWith('.mp4') || backgroundUrl.endsWith('.webm'));
...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-[calc(100vh_-_5rem)] flex items-center justify-center p-4 relative overflow-hidden">
      <LoginBackground backgroundUrl={backgroundUrl} />
      <motion.div
